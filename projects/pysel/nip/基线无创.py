...
from com.测试环境.getData import get_items, get_instuments, get_barcodes
...
def specimen_add(browser):
    ...
    # 姓名
    browser.find_element_by_id('txtPatientName').send_keys('屏蔽无创')
    # 性别
    ...
    # 申请单号
    sqdh = browser.find_element_by_id('txtApplyNo')
    sqdh.send_keys('550000000000600')
    sleep(1)
    '''
    无创信息
    '''
    ...
    # 诊疗卡号
    browser.find_element_by_id('txtPatientNo').send_keys('106000206800')
    # 床号
...
def specimen_distribute(browser, tmh_list):
    ...
    for tmh in tmh_list:
        ...
        sleep(2)
    # 接收人倒三角
    browser.find_element_by_xpath('//*[@id="comboBtn4"]/a').click()
    # 对接收人文本框进行回车按键
    browser.find_element_by_xpath('//*[@id="comboText4"]').send_keys(Keys.ENTER)
...
def specimen_result(browser, tmh_list, xmjg):
    ...
    # 结果录入
    browser.find_element_by_xpath(
        '//*[@id="treeboxbox_tree"]/div/table/tbody/tr[8]/td[2]/table/tbody/tr[5]/td[2]/table/tbody/tr/td[4]/span/a').click()
    sleep(1)
    # 转到 iframe
    browser.switch_to.frame('content')
